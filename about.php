...
<!-- Mirrored from templates.hibootstrap.com/zoben/default/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Nov 2024 10:02:48 GMT -->
<head>
        <!-- Required Meta Tags -->
        <meta charset="UTF-8">
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            ...
                            <div class="others-options d-flex align-items-center">
                                <div class="optional-item">
                                    <a href="log-in-register.html" class="default-btn two border-radius-5">Login / Register <i class="ri-user-3-line"></i></a>
                                </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="about-img">
                            <div class="row">
                                <div class="col-6">
                                    <img src="assets/images/about-img1.jpg" alt="Images">
                                </div>
                                <div class="col-6">
                                    <img src="assets/images/about-img2.jpg" alt="Images">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="about-content pl-20">
                            <div class="section-title">
                                <h2>About Zoben</h2>
                                <div class="bar"></div>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Feugiat enim a erat sit vulputate elementum orci. Risus nec viverra ornare venenatis proin ac varius tristique ut. Vitae egestas tellus amet nulla cursus.ands Pellentesque placerat maecenas egestas ullamcorper sed nunc. Vitae egestas tellus amet nulla something loss Pellentesque placerat maecenas egestas.</p>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Feugiat enim a erat sit vulputate elementum orci. Risus nec viverra ornare venenatis proin ac varius tristique ut. Vitae egestas tellus amet nulla cursus in that. Pellentesque placerat maecenas egestas ullamcorper sed sarinto.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="services-area pt-100 pb-70">
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <p class="m-auto">Every single one of our jobs has some kind of flexibility option.</p>
                </div>
                ...
                <div class="row pt-45 justify-content-center">
                    <div class="col-lg-4 col-6">
                        <div class="services-card">
                            ...
                            <h3><a href="candidates-dashboard-shortlisted-job.html">Advertise A Job</a></h3>
                            <p>Single one of our jobs has some kind of flexibility option.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-6">
                        <div class="services-card">
                            ...
                            <h3><a href="candidates-dashboard-cv-manager.html">CV Search</a></h3>
                            <p>Single one of our jobs has some kind of flexibility option.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-6">
                        <div class="services-card">
                            ...
                            <h3><a href="candidates-dashboard-shortlisted-job.html">Display Job</a></h3>
                            <p>Single one of our jobs has some kind of flexibility option.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-6 col-md-4">
                        <div class="counter-card">
                            <h3><span class="odometer" data-count="14">00</span>K</h3>
                            <div class="bar m-auto"></div>
                            <p>Over 14k open job positions</p>
                        </div>
                    </div>

                    <div class="col-lg-4 col-6 col-md-4">
                        <div class="counter-card">
                            <h3><span class="odometer" data-count="1,87,113">000000</span></h3>
                            <div class="bar m-auto"></div>
                            <p>1,87,113 Total job posted</p>
                        </div>
                    </div>

                    <div class="col-lg-4 col-6 col-md-4">
                        <div class="counter-card">
                            <h3><span class="odometer" data-count="5">0</span>M</h3>
                            <div class="bar m-auto"></div>
                            <p>5 million daily active users</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="career-area pb-70">
            <div class="container">
                <div class="row align-items-center">
                            ...
                            <div class="row align-items-center">
                                <div class="col-6">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="images1">
                                                <img src="assets/images/career/career-img1.jpg" alt="Images">
                                            </div>
                                        </div>

                                        <div class="col-12">
                                            <div class="images3">
                                                <img src="assets/images/career/career-img2.jpg" alt="Images">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="images2">
                                                <img src="assets/images/career/career-img3.jpg" alt="Images">
                                            </div>
                                        </div>

                                        <div class="col-12">
                                            <div class="images4">
                                                <img src="assets/images/career/career-img4.jpg" alt="Images">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="career-content pl-20">
                            <div class="section-title">
                                <h2>Quick<b> Career Tips </b> Help You to Get the Best Job That Fits You</h2>
                                <div class="bar"></div>
                            </div>
                            <div class="content">
                                <img src="assets/images/career/career-user.png" alt="Images">
                                <h3>Thomas Abedin</h3>
                            ...
                            <ul>
                                ...
                                <li class="title">1000+ Freelancers Get Result </li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-4">
                            <div class="employers-cv-btn">
                                <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#f3909c9d87929087b3899c91969ddd909c9e">Upload Your CV</a>
                            </div>
                        </div>
                    </div>
                </div>
                                 ...
                                 <ul class="footer-contact-list">
                                   <li>
                                    ...
                                    <li>
                                        ...
                                        <div class="content">
                                            <a href="https://templates.hibootstrap.com/cdn-cgi/l/email-protection#78101d1414173802171a1d16561b1715">
                                                <span class="__cf_email__" data-cfemail="4d25282121220d37222f2823632e2220">[email&#160;protected]</span>
                                            </a>
                                        </div>
                                    </li>
                                    <li>
